...
clear @a[tag=ultimate_beast,tag=triggered_ultimate] minecraft:warped_fungus_on_a_stick

# others
effect give @a[tag=ultimate_beast,tag=triggered_ultimate] minecraft:speed 20 1 true
effect give @a[tag=ultimate_beast,tag=triggered_ultimate] minecraft:strength 20 1 true
team join red @a
